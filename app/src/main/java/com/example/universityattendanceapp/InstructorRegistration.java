        ...
        buttonReg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(email)){
                    Toast.makeText(InstructorRegistration.this, "Enter email", Toast.LENGTH_SHORT).show();
                    return;
                }
                if(TextUtils.isEmpty(password)){
                    Toast.makeText(InstructorRegistration.this, "Enter password", Toast.LENGTH_SHORT).show();
                    return;
                }
                                ...
                                if (task.isSuccessful()) {
                                    ...
                                    referenceProfile.child(firebaseUser.getUid()).setValue(writeUserDetails).addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            ...
                                            Toast.makeText(InstructorRegistration.this, "Account Created.",
                        ...
                        .addOnFailureListener(new OnFailureListener() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                if(e  instanceof FirebaseAuthUserCollisionException){
                                    Toast.makeText(InstructorRegistration.this, "Email Already in use",
                                            Toast.LENGTH_SHORT).show();
                                }
