...
public class M_Courses extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(M_Courses.this,
    ...
    public void logout(View view) {
        ...
        startActivity(new Intent(M_Courses.this, MainActivity.class));
        finish();
    }
}
